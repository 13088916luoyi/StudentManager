...
void AuthController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AuthController::*)(const User & )>(_a, &AuthController::loginSuccess, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AuthController::*)(const QString & )>(_a, &AuthController::loginFailed, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (AuthController::*)()>(_a, &AuthController::logoutSuccess, 2))
            return;
    }
}
...
// SIGNAL 0
void AuthController::loginSuccess(const User & _t1)
{
